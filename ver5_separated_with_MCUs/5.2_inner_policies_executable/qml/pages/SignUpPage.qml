    ...
    Column {
        ...
        Flickable {
            ...
            Column {
                ...
                Text {
                    text: "Root Officer에게 받은 초대 코드가 필요합니다"
                    font.family: Theme.fontFamily
                    font.pixelSize: 12
                    color: "#888888"
                    anchors.horizontalCenter: parent.horizontalCenter
                ...
                // 초대 코드
                Text { text: "초대 코드"; font.family: Theme.fontFamily; font.pixelSize: 13; color: "#c0392b"; leftPadding: 4; font.bold: true }
                AppTextField {
                    id: inviteCodeField
                    placeholderText: "예: A3F8K2"
                ...
                AppButton {
                    text: "회원 가입하기"
                    onClicked: appController.signUpWithInvite(
                        signUpIdField.text,
                        signUpPwField.text,
