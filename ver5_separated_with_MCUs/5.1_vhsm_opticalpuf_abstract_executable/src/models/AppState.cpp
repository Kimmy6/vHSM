...
QString AppState::cryptoResult() const { return m_cryptoResult; }
void AppState::setCryptoResult(const QString &v)          { if (m_cryptoResult==v) return; m_cryptoResult=v; emit cryptoResultChanged(); }

QString AppState::resultFilePath() const { return m_resultFilePath; }
void AppState::setResultFilePath(const QString &v)        { if (m_resultFilePath==v) return; m_resultFilePath=v; emit resultFilePathChanged(); }
