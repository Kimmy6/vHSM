...
class AppState : public QObject
{
    ...
    Q_PROPERTY(QString cryptoResult              READ cryptoResult              WRITE setCryptoResult              NOTIFY cryptoResultChanged)
    // 결과 파일 경로 (갤러리 저장 후 표시)
    Q_PROPERTY(QString resultFilePath            READ resultFilePath            WRITE setResultFilePath            NOTIFY resultFilePathChanged)
...
public:
    ...
    QString resultFilePath()             const;  void setResultFilePath(const QString &v);
